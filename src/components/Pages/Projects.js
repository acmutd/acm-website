...
import ProgramComponents, { Directors, Experience, WinningProjects } from './ProgramComponents';
    ...
    return (
        <div>
            ...
            <div className='programs-format'>
                ...
                <h2 style={{fontSize:'1.5rem', fontWeight:'300', color:'#CACACA'}}>SP22 1st place</h2>

                <WinningProjects
                image={
                <img style={{width:'100%'}} src={winningProjectImage1}>
                </img>
                }
                name={'project name'}
                githubLink={'link1'}
                ...
                <h2 style={{fontSize:'1.5rem', fontWeight:'300', color:'#CACACA'}}>F21 1st place</h2>
                ...
                <h2 className='subheading1' style={{paddingTop:'10%'}}>frequently asked questions</h2>

                <h2 className='questionText'>What is the application process like?</h2>
                <h2 className='answerText' style={{paddingBottom:'5%'}}>The first step is to fill out our application. Our application consists of general questions intended to give us insight into your previous development and leadership experience. From these applications, we select the most promising candidates for one-on-one interviews. The interview is the last step of the application process. Based on the application and interview, we select the very best candidates to create around 8 teams of 5 people.</h2>

                <h2 className='questionText'>Do I need to have prior development experience?</h2>
                <h2 className='answerText' style={{paddingBottom:'5%'}}>ACM Projects is designed for those new to software development. Although some experience is great, we're looking for passionate and committed candidates who have a desire to learn and grow in software development</h2>

                <div className='faqImagesContainer'>
                    <img className='faqImage' src={faqImage1}></img>
                    <img className='faqImage' src={faqImage2}></img>
                </div>
                <h2 className='questionText' style={{paddingTop:'5%'}}>How do I stand out during the application process?</h2>
                <h2 className='answerText' style={{paddingBottom:'5%'}}>Be genuine! We want to see your passion for technology and desire to learn. We can only judge your experience and character based on what we see in the application, so fill all of the questions out! Leaving questions blank is a lost opportunity for us to learn more about you.</h2>
                
                <h2 className='questionText'>How is ACM Projects structured?</h2>
                <h2 className='answerText' style={{paddingBottom:'5%'}}>You will be placed into a team of five students with a project and a mentor. We will have weekly (and mandatory) build nights every Wednesday from 8:30 pm - 10:00 pm. This is time for you to work with your team, meet with your mentor and learn. Some build nights may include a short tech-related workshop designed to diversify your tech skills. </h2>

                <h2 className='questionText'>What is the time commitment?</h2>
                <h2 className='answerText' style={{paddingBottom:'5%'}}>The minimum time commitment is the 1.5 hours required for each weekly build night. Beyond this, you and your team may need extra time to complete your project so it's up to you to schedule the time amongst yourselves. </h2>
            </div>
