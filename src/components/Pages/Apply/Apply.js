  ...
  return (
    <div className='format'>
        ...
        <div className='image-format'>
          ...
          <div>
            <div className='card' style= {{ height: "100%", width: "400%" }}>   
              ...
              <h2 className='subheading1'>
              All open applications can be found in our member portal at portal.acmutd.co/applications' 
              </h2>
          ...
          <img className='apply-img'src={img1} alt='group-photo1'/>
        ...
        <div className='body-format'>
          ...
          <div className= 'button-format'>
            <h1 className = 'body1'>
            ACM offers a multitude of programs all targetted towards helping students get a start on their career
            </h1>
            <h2 className= 'button-temp'>
            button here
            </h2>
          </div>
