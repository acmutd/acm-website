  ...
  return (
    <div className="director">
      ...
      <div className="director-text-container">
        <h2 className="director-text" style={{ fontSize: "1.3rem" }}>
          {name}
        </h2>
        <h2 className="director-text" style={{ fontSize: "1.1rem" }}>
          {description}
        </h2>
      </div>
    </div>
  ...
  return (
    <div className="grid">
      ...
      <div className="grid-item4">
        <h2 style={{ color: "#9C9C9C", fontSize: "1rem", fontWeight: "300" }}>
          {description}
        </h2>
      </div>
